  ...
  Struct[
    {
      ...
      google_credentials   => Optional[Variant[Sensitive[String],String]],
      google_project_id    => Optional[Variant[Sensitive[String],String]],
      google_repository    => Optional[Variant[Sensitive[String],String]],
