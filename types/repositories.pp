  ...
  Struct[
    {
      ...
      backup_timer_random_delay  => Optional[Variant[String[1],Integer]],
      ...
      forget_timer_random_delay  => Optional[Variant[String[1],Integer]],
      ...
      restore_timer_random_delay => Optional[Variant[String[1],Integer]],
