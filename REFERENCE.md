...
* [`restic`](#restic): Module to manage restic repositories.
Supported features:
...
##### <a name="repository_host"></a>`repository_host`
...
##### <a name="repository_name"></a>`repository_name`
...
Default value: `"/tmp/restic_restore/${title}"`
